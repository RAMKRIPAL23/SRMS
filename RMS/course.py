...
class CourseClass:
  def __init__(self,root):
    ...
    #----TItle----
    title=Label(self.root,text="Mange Course Details",font=("goudy old style",20,"bold"),bg="#033053",fg="white").place(x=10,y=15,width=1180,height=35)
    ...
    try:
        if self.var_course.get() == "":
            ...
            if row!=None:
               ...
               con.commit()
               messagebox.showinfo("Seccess","Course Added Seccussfully",parent=self.root)
               self.show()
    except Exception as ex:
    ...
    try:
        if self.var_course.get() == "":
            ...
            if row == None:
               ...
               con.commit()
               messagebox.showinfo("Seccess","Course Update  Seccussfully",parent=self.root)
               self.show()
    except Exception as ex:
        messagebox.showerror("Error", f"Error due to {str(ex)}")
